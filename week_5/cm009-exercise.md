...
```r
guest_long %>% 
  separate(name, into = c("first", "last"), sep = " ") %>% # names are separated by a space
...
```r
guest %>% # tibble 'guest' has different columns for each event.
  group_by(party) %>% 
...
##    label         x       y
##    <chr>     <dbl>   <dbl>
##  1 Sample A -0.353 -0.807 
##  2 Sample A  0.377  0.315 
##  3 Sample A  0.452  0.651 
##  4 Sample A  0.994  0.844 
##  5 Sample A -0.374 -0.590 
##  6 Sample A -0.274  1.32  
##  7 Sample A -0.568  0.0893
##  8 Sample A -1.20  -1.52  
##  9 Sample A -0.826 -0.619 
## 10 Sample A -0.647 -1.37  
## # ... with 90 more rows
```
...
##   <chr>  <chr> <dbl>         <dbl>         <dbl>
## 1 Alex   a         1         0.592        0.272 
## 2 Alex   a         2         0.243        0.0967
## 3 Alex   a         3         0.117        0.453 
## 4 Robert b         1         0.763        0.284 
## 5 Robert b         2         0.220        0.448 
## 6 Robert b         3        NA           NA     
## 7 Sam    a         1         0.335        0.0602
## 8 Sam    a         2        NA           NA     
## 9 Sam    a         3        NA           NA
```
